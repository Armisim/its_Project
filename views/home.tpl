...
<p style="background-color:blue; color:white; font-size: 20px;  height: 35px;">Questa è l'homepage della Web App progettata per la gestione remota dell'impianto di condizionamento, premendo "tabella" accederai al log con tutte le registrazioni della temperatura superiore alla soglia fissata (nel nostro caso 27 C°), inoltre potrai aggiornare oppure svuotare la tabella dei log a tuo piacimento</p>
